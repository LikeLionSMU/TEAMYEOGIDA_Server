...
CREATE TABLE `productsell` (
  ...
  `sell_personpid` varchar(45) DEFAULT NULL,
  `sell_productpid` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idx`),
  KEY `fk_sell_personpid_idx` (`sell_personpid`),
  KEY `productsell_ibfk_1` (`sell_productpid`),
  CONSTRAINT `fk_sell_personpid` FOREIGN KEY (`sell_personpid`) REFERENCES `profile1` (`kakaopid`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2018-07-24 18:49:03
